...
console.log(result);
//Q3
console.log("Before trim operation: ", test.length);
...
console.log("first characteris =", char1);

var char2 = result1.charAt(result1.length-1);
console.log("last characteris =", char2);
//Q6
var word = "ram, seeta, pramod, anjali,rutuja";
...
//Q10
var start = result1.startsWith("Hey");
console.log("string end with =", start);